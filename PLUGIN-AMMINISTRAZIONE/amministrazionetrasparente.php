...
add_action( 'init', function() {
  ...
  // Custom Post Type
    ...
    if ( at_option('enable_cat') ) { $taxonomysupport[] = 'category'; }
    ...
    at_option( 'debug' ) ? $cap = array() : $cap = array('manage_terms' => 'utentealieno','edit_terms' => 'utentealieno','delete_terms' => 'utentealieno' );
    $args = array(
        'labels' => $labels,
        'public' => true,
        'show_in_nav_menus' => true,
...
/* Menu di navigazione della trasparenza*/

add_shortcode('at-head-collapse', function($atts) {
    ob_start();
    include(plugin_dir_path(__FILE__) . 'shortcodes/shortcodes-head-collapse.php');
