...
> Con questo plugin potrai gestire le sezioni richieste dalla normativa direttamente nel tuo sito WordPress, senza il bisogno di affidarsi a fornitori di terza parte!

L'intero modulo gestisce ogni voce come singolo post velocizzando la pubblicazione e consentendo di inserire file, immagini, testi, link o effettuare un reindirizzamento a un'altra pagina.
