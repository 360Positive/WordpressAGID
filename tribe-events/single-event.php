                    ...
                    <div class="col-md-12 content-event">
                        ...
                        <?php if (tribe_has_organizer()) {
                            ...
                            <div class="event-organiz" style="display:none">
                                <div><h5>Organizzato da: <?php echo tribe_get_organizer(); ?></div>
                                </h5>
                                <hr>
                                <?php
                                ...
                                <?php if ($mail != "") { ?>
                                    <div><i class="icofont icofont-ui-email"></i> <a
                                            href="mailto:<?php echo $mail; ?>"><?php echo $mail; ?></a></div>
                                <?php }
                                if ($web != "") {
                                    ?>
                                    <div><i class="icofont icofont-web"></i> <a
                                            href="<?php echo $web; ?>"><?php echo $web; ?></a></div>
                                <?php }
                                if ($phone != "") {
                                    ?>
                        ...
                        <div class="tribe-events-single-event-description tribe-events-content">
                            ...
                            ?>
                            <a href="<?php echo $locandina; ?>" target="_blank"><img class="locandina" src="<?php echo $locandina; ?>"></a>
...
<div class="row dati-evento-footer">
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <?php }?>
            <div class="col-md-12">
            <small>Non si assumono responsabilità per eventuali modifiche ai programmi o per variazioni di data.</small>
            </div>
