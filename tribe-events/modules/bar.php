...
<div id="tribe-events-bar">
	...
	<form id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form"
		...
		<div id="tribe-bar-collapse-toggle"
			...
			<?php printf( esc_html__( 'Find %s', 'the-events-calendar' ), tribe_get_event_label_plural() ); ?><span
				class="tribe-bar-toggle-arrow"></span>
		</div>
		...
		<?php if ( count( $views ) > 1 ) { ?>
			...
			<div class="tribe-bar-views-inner tribe-clearfix">
				...
				<select
					...
					name="tribe-bar-view" tabindex="0"
