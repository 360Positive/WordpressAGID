...
<div class="tribe-mini-calendar-grid-wrapper">
	<table class="tribe-mini-calendar"
		<?php tribe_events_the_mini_calendar_header_attributes() ?>>
		...
		<thead class="tribe-mini-calendar-nav">
			<tr>
				<td colspan="7">
					...
					<img id="ajax-loading-mini"
							src="<?php echo tribe_resource_url( 'images/tribe-loading.gif' ) ?>"
							alt="loading..." />
					</div>
				</td>
			</tr>
