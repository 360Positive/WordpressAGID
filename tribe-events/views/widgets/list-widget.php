...
<ol class="tribe-list-widget">
    ...
    foreach ($posts as $post) :
        ...
        ?>
			<li
		class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				<?php
        if (tribe('tec.featured_events')->is_featured(get_the_ID()) && get_post_thumbnail_id($post)) {
             ...
             * @since 4.5.13
             *       
             * @param bool $featured_image_link
             *            Whether the featured image link should be added or not
             */
...
<p class="tribe-events-widget-link">
	<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"
		rel="bookmark"><?php printf( esc_html__( 'View All %s', 'the-events-calendar' ), $events_label_plural ); ?></a>
</p>
