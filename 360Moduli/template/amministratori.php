...
<tr>
	<td><?= $nameTable ?></td>
	<td>Non sono presenti documenti della tipologia indicata.</td>
	<td></td>
	<td></td>
</tr>
<?php
...
if (get_field('in_carica') == 1) {
                        ...
                        <h4>
							Importi di viaggio e missioni<br>
							<small>art.14 comma 1 lettera c</small>
						</h4>
						<h4>
							Emolumenti percepiti per l'incarico politico<br>Indennità di
							carica - <small>art.14 comma 1</small>
						</h4>
		...
		<div class="alert alert-info" role="alert" style="padding-top: 2.5em">
			<p>
				Legenda <br> Riferimenti normativi delle sezioni indicate nella
				pagina. Art. 14, c. 1, lett. a), d.lgs. n. 33/2013
			</p>

			<p>
				<b style="font-size: 25pt;">A</b> Atto di nomina o di proclamazione,
				con l'indicazione della durata dell'incarico o del mandato elettivo.
			</p>
			<hr>
			<p>
				<b style="font-size: 25pt;">B</b> Curricula
			</p>
			<hr>
			<p>
				<b style="font-size: 25pt;">C</b> Compensi di qualsiasi natura
				connessi all'assunzione della carica; importi di viaggio, servizio e
				missioni pagati con fondi pubblici.
			</p>
			<hr>
			<p>
				<b style="font-size: 25pt;">D</b> Dati relativi all'assunzione di
				altre cariche, presso enti pubblici o privati, e relativi compensi a
				qualsiasi titolo corrisposti.
			</p>
			<hr>
			<p>
				<b style="font-size: 25pt;">E</b> Altri eventuali incarichi con
				oneri a carico della finanza pubblica e indicazione dei compensi
				spettanti.
			</p>
			<hr>
			<p>
				<b style="font-size: 25pt;">F</b> Le dichiarazioni di cui
				all'articolo 2 della legge 5 luglio1982, n. 441, nonché le
				attestazioni e dichiarazioni di cui agli articoli 3 e 4 della
				medesima legge, come modificata dal presente decreto, limitatamente
				al soggetto, al coniuge non separato e ai parenti entro il secondo
				grado, ove gli stessi vi consentano. Viene in ogni caso data
				evidenza al mancato consenso. Alle informazioni di cui alla presente
				lettera concernenti soggetti diversi dal titolare dell'organo di
