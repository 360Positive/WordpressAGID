...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="card-deck">
                ...
                foreach ($myposts as $post) :
					...
					<div class="card-body ">
						...
						<br> <small class="text-muted date-card"><?= get_the_date(); ?></small>
			...
			<a href="<?= get_category_link($cat) ?>" class="pull-right"
				title="Apre sezione interna del sito con tutte le notizie">
				<h2 class="lastnews">Tutte le notizie</h2>
			</a>
		</div>
	</div>
