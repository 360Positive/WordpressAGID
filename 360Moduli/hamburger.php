...
<?php 	
	...
	function createMenu($menitem){		
		...
		?>		
		<a href="#<?= str_replace(' ','',$item->post_title) ?>" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><?= $item->post_title?></a>		
		<ul class="collapse list-unstyled" id="<?= str_replace(' ','',$item->post_title) ?>">			
						
			<?php if ($item->classes!=null){				
				$sub=$item->classes;				
...
<nav id="sidebar" class="wrapper collapse">	
	<div class="sidebar-header">		
		...
		<h1><i id="menuCollapse" class="icofont-ui-close"></i></h1>		
	</div>	
	<?php		
