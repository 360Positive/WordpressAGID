    ...
    <div id="sliderInd" class="carousel slide" data-ride="carousel">
        <div class="carousel-indicators">
            ...
            <div id="carouselButtons">
                ...
                <button id="pauseButton" type="button" class="btn btn-default btn-xs" vlaue="pause" title="pause">
                ...
                <div class="carousel-item <?= $i == 0 ? 'active' : ''; ?>">
                    <div class="row rowBack h-100">
                        <div class="col-12 col-lg-6 leftSlide d-block w-50 h-100">
                            <h1 class="titleslider py-2 px-2 my-1 mx-1 " style="background:#ffb401!important"> <?= get_the_title(); ?></h1>
                            <hr>
                            <p class="slidecontent text-justify py-2 px-2 my-1 mx-1"
                               style=" background: aliceblue!important;"> <?php get_the_category(); ?>

                            <a href="<?= get_permalink() ?>" title="<?php the_title(); ?>"><?
                                echo substr(get_the_content(), 0, 400) . '...' ?> </a>
                        ...
                        <div class="col-12 col-lg-6 rightSlide d-block w-50 h-100">
                            <img alt="<?= get_the_post_thumbnail_url() ?>" class="d-block w-100 immagine"
