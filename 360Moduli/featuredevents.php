...
.card-title.featuredevent {
	...
	background: linear-gradient(180deg, rgba(255, 179, 0, 1) 0%,
				...
				<div class="card-deck">
                    ...
                    foreach ($myposts as $post) :
						...
						<img class="card-img-top "
							...
							alt="<?php the_title(); ?>"
							style="max-height: 400px; min-height: 180px;">
						...
						<div class="card-body">
							<p cla="text-sm-center"><? echo substr(get_the_excerpt(), 0, 100) . '...'; ?>
                               <a href="<?= get_permalink() ?>"
									title="<?php the_title(); ?>"> <strong><?= _("Leggi"); ?></strong>
								</a>
							</p>
						</div>
...
endforeach
				...
				<a class="pull-right" href="https://turismo.comuneacqui.it/"
					title="Apre sito esterno Turismo Comune di Acqui Terme"><h2
						class="featuredevent">Tutti gli eventi</h2></a>
			</div>
		</div>
