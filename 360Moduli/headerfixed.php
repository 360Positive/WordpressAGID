			...
			<div class="container-fluid" style="margin: 0px">
                ...
                <div class="row">
					<div class="dropdown col-12 my-0" style="padding: 10px">
						<a href="#droptop_btn-fix" id="droptop_btn-fix"
							class="button_dropdown"
							title="Turismo, Acquistoria, Acquiambiente"> Turismo,
							Acquistoria, Acquiambiente <i id="freccia"
						...
						<div id="message_drop_top-fix" class="row" style="display: none">
							...
							<div class="col-md-8">
								<div class="row">
									<div class="col-md-4">
										<a target="_blank" href="https://turismo.comuneacqui.it/"
											title="Apre sito esterno del Turismo di Acqui Terme"> Sito
											Turistico di Acqui Terme <i class="icofont-external-link"></i>
										</a>
									</div>
									<div class="col-md-4">
										<a target="_blank" href="https://acquistoria.it/"
											title="Apre sito esterno del Premio Acqui Storia"> Sito
											Premio Acqui Storia <i class="icofont-external-link"></i>
										</a>
									</div>
									<div class="col-md-4">
										<a target="_blank" href="https://acquiambiente.it/"
											title="Apre sito esterno del Premio Acqui Ambiente"> Sito
											Premio Acqui Ambiente <i class="icofont-external-link"></i>
										</a>
									</div>
								</div
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-12">
							...
							<label for="show-menu-main" class="show-menu-main">Menu</label> <input
								type="checkbox" id="show-menu-main" role="button">
