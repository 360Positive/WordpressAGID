<?php
/**
 * Template name: Locali - Bar - Gelaterie
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if (get_field('img0')) {
                    ...
                    echo ' <img src="https://turismo.comuneacqui.it/wp-content/uploads/2019/06/full-no-foto-turismo-acqui-terme-.jpg" width="100%"/>';
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <section class="entry-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <?php
                                if (get_field('indicazione')) {
                                 echo "<span class='label label-orange'>"._("Tipologia locale:")."</span><br>";
                                  $lang=get_field('indicazione');
                                  
                                echo '<div class="row" style="margin-top:30px">';
                                    echo '<div class="col">';
                                        echo '<div class="row" style="text-align:center">';
                                            echo '<div class="col-md-12">';
                                            echo '<i class="'.$lang['value'].'" style="font-size:2em"></i>';
                                            echo '</div>';
                                            echo '<div class="col-md-12">';
                                            echo _($lang['label']);
                                            echo '</div>';
                             ...
                             <div class="col-md-8">
                                <?php
                                if (get_field('servizi')) {
                                    echo "<span class='label label-orange'>"._("Servizi:")."</span>";
                                  
                                  echo '<div class="row" style="margin-top:30px">';
                                  
                                    foreach (get_field('servizi') as $lang) {
                                        echo '<div class="col">';
                                        echo '<div class="row" style="text-align:center">';
                                        echo '<div class="col-md-12">';
                                        echo '<i class="'.$lang['value'].'" style="font-size:2em"></i>';
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-12">
                                        <?php if (get_field('facebook')) {
                                            ...
                                            echo '<a href="' . get_field('web') . '">';
                                            echo '<i class="icofont-facebook"></i>  ' . get_field('web');
                                            echo '</a>';
                                    ...
                                    <div class="col-md-12">
                                        <?php if (get_field('instagram')) {
                                            ...
                                            echo '<a href="' . get_field('instagram') . '">';
                                            echo '<i class="icofont-instagram"></i>  ' . get_field('web');
                                            echo '</a>';
