...
<html <?php language_attributes(); ?>>
	<head>
        ...
        <script rel="stylesheet" href="<?= get_site_url()?>/wp-content/themes/design-italia-child/lib/faicon/all.js"></script>
        ...
        <?php /*---   JQuery Carousel   ----*/?>
        <link rel="stylesheet" href="<?= get_site_url()?>/wp-content/themes/design-italia-child/lib/responsive-image-carousel-lightbox/css/lightbox.css">
       ...
       <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>-->
        ...
        <script type="text/javascript" src="<?= get_site_url()?>/wp-content/themes/design-italia-child/360Moduli/jssocial/jssocials.min.js"></script>
                            ...
                            */?>
							<div class="row"  >
								<div class="dropdown col-12" style="padding:10px">
								    <a href="#" id="droptop_btn" class="button_dropdown" title="Turismo, Acquistoria, Acquiambiente">
								        Turismo, Acquistoria, Acquiambiente  <i id="freccia" class="icofont-rounded-down"></i></a>
								    
								<div id="message_drop_top" class="row" style="display:none" >
								<div class="col-md-2"></div>
								<div class="col-md-8">
								    <div class="row">
								        <div class="col-md-4"><a href="https://turismo.comuneacqui.it/" title="Apri sito esterno del Turismo di Acqui Terme">
								            Sito Turistico di Acqui Terme <i class="icofont-external-link"></i></a></div>
								        <div class="col-md-4"><a href="https://acquistoria.it/" title="Apri sito esterno del Premio Acqui Storia">
								            Sito Premio Acqui Storia <i class="icofont-external-link"></i></a></div>
								        <div class="col-md-4"><a href="https://acquiambiente.it/" title="Apri sito esterno del Premio Acqui Ambiente">
								            Sito Premio Acqui Ambiente <i class="icofont-external-link"></i></a></div>
										</div
								</div>
								<div class="col-2"></div>
								</div>
                            ...
                            */?>
							...
							<div class=" col-md-12">
							    <div class="row" style="margin-bottom:0.8%; margin-left:0.90%">
								    ...
								    <div class="col-md-4" ><a href="https://www.regione.piemonte.it" title="Apri sito esterno della Regione Piemonte">Regione Piemonte</a></div>
										   ...
										   <div class="row ">
    									        <div class="it-socials col-md-12">
    									            <div class="row ">
    									                <div class="col-3">
    									                    <div class="row ">
    									                        <div class="col-md-auto d-none d-md-block d-lg-block d-xl-block" style="font-size:18px">Seguici su</div>
    									                    </div>
    									                </div>
    									                <div class="col-8" style="left:-15px;">
    									        ...
    									        <div class="it-search-wrapper col-md-10">
    									            <?php get_search_form(); ?>
    									            <script>
    									        ...
    									        <div class="it-search-wrapper col-md"><i id="sidebarCollapse" class="icofont-navigation-menu"></i>
    									        </div>
									        </div>
										 </div>
									</div>
