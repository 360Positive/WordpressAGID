...
{ ?>
    <style type="text/css">
        .it-header-center-wrapper, .it-header-navbar-wrapper, .it-header-wrapper {
            background-color: <?php echo get_theme_mod( 'wppa_head_color', "#0066cc" ); ?>;
        }
        ...
        button, input[type="submit"], .btn-primary {
            background-color: <?php echo get_theme_mod( 'wppa_link_color', "#0066cc" ); ?>;
        }
        ...
        .btn-outline-primary {
            color: <?php echo get_theme_mod( 'wppa_link_color', "#0066cc" ); ?>;
            box-shadow: inset 0 0 0 1px<?php echo get_theme_mod( 'wppa_link_color', "#0066cc" ); ?>;
        }

        .btn-outline-primary:hover, .btn-outline-primary:not(:disabled):not(.disabled):active {
            color: <?php echo get_theme_mod( 'wppa_link_color', "#0066cc" ); ?>;
            box-shadow: inset 0 0 0 2px<?php echo get_theme_mod( 'wppa_link_color', "#0066cc" ); ?>;
        }

        html, #footer, .it-footer-main {
            background-color: <?php echo get_theme_mod( 'wppa_footer_color', '#004080' ); ?>;
        }

        #footer a {
            color: <?php echo get_theme_mod('wppa_footer_link', "#ffffff"); ?>;
        }
    </style>
    <?php
}
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class('card card-bg'); ?> >
                        ...
                        <article id="post-<?php the_ID(); ?>" <?php post_class('card'); ?> >
                          ...
                          <?php the_date(); ?>
                                ...
                                <?php } ?>
                                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="read-more">Leggi
                                    di pi&ugrave; &nbsp;<span class="it-arrow-right"></span></a>
                            </div>
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('number'); ?>"
                   name="<?php echo $this->get_field_name('number'); ?>" type="number" value="<?php echo $number; ?>"
                   size="3"/>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('cat_id'); ?>"><?php _e('Seleziona la categoria:') ?></label>
            <select id="<?php echo $this->get_field_id('cat_id'); ?>"
        ...
        <p>
            ...
            <input type="checkbox" id="<?php echo $this->get_field_id('excerpt'); ?>"
                   name="<?php echo $this->get_field_name('excerpt'); ?>" value="true" <?php echo $checked; ?> />
        ...
        <p>
            ...
            <input type="checkbox" id="<?php echo $this->get_field_id('categories'); ?>"
                   name="<?php echo $this->get_field_name('categories'); ?>" value="true" <?php echo $checked; ?> />
        ...
        <p>
            ...
            <input type="checkbox" id="<?php echo $this->get_field_id('date'); ?>"
                   name="<?php echo $this->get_field_name('date'); ?>" value="true" <?php echo $checked; ?> />
        ...
        <p>
            ...
            <input type="checkbox" id="<?php echo $this->get_field_id('shadow'); ?>"
                   name="<?php echo $this->get_field_name('shadow'); ?>" value="true" <?php echo $checked; ?> />
