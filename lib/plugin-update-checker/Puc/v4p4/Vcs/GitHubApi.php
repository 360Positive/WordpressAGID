    ...
    class Puc_v4p4_Vcs_GitHubApi extends Puc_v4p4_Vcs_Api
    {
        ...
        public function getLatestRelease()
        {
            ...
            if ($this->releaseAssetsEnabled && isset($release->assets, $release->assets[0])) {
                ...
                $matchingAssets = array_filter($release->assets, array(
                    $this,
                    'matchesAssetFilter'
                ));
        ...
        {
            $commits = $this->api('/repos/:user/:repo/commits', array(
                'path' => $filename,
                'sha' => $ref
            ));
        ...
        public function getRemoteFile($path, $ref = 'master')
        {
            ...
            $response = $this->api($apiUrl, array(
                'ref' => $ref
            ));
         ...
         *
         * @param string|null $fileNameRegex
         *            Optional. Use only those assets where the file name matches this regex.
         */
