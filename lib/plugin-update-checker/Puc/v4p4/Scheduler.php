...
if (! class_exists('Puc_v4p4_Scheduler', false)) :
    ...
    class Puc_v4p4_Scheduler
    {
        ...
        protected $hourlyCheckHooks = array(
            'load-update.php'
        );
         ...
         */
        public function __construct($updateChecker, $checkPeriod, $hourlyHooks = array(
            'load-plugins.php'
        ))
        {
            ...
            if ($this->checkPeriod > 0) {
                ...
                add_action($this->cronHook, array(
                    $this,
                 ...
                 */
                add_action('load-update-core.php', array(
                    $this,
                    'maybeCheckForUpdates'
                ));
        ...
        protected function getEffectiveCheckPeriod()
        {
            ...
            if (in_array($currentFilter, array(
        ...
        /**
         * Get the name of the update checker's WP-cron hook.
