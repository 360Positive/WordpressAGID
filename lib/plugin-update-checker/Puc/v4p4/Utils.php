...
if (! class_exists('Puc_v4p4_Utils', false)) :
    ...
    class Puc_v4p4_Utils
    {
         ...
         *            Get an entry from this array.
         * @param array|string $path
         *            A list of array keys in hierarchy order, or a string path like "foo.bar.baz".
         * @param mixed $default
         *            The value to return if the specified path is not found.
         * @param string $separator
         *            Path element separator. Only applies to string paths.
         * @return mixed
         */
         ...
         *            Returns this value if there are no non-empty elements.
         * @return mixed|null
         */
