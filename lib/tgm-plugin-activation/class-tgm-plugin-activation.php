...
if (! class_exists('TGM_Plugin_Activation')) {
    ...
    class TGM_Plugin_Activation
    {
        ...
        /**
         * Flag to set automatic activation of plugins.
         * Off by default.
         *
         * @since 2.2.0
         *       
        ...
        public function __construct()
        {
            ...
            do_action_ref_array('tgmpa_init', array(
                $this
            ));
        ...
        public function init()
        {
             ...
             *       
             * @param bool $load
             *            Whether or not TGMPA should load.
         ...
         *       
         * @param string $mofile
         *            Full path to the target mofile.
         * @param string $domain
         *            The domain for which a language file is being loaded.
...
<div class="tgmpa wrap">
	<h1><?php echo esc_html( get_admin_page_title() ); ?></h1>
		...
		<input type="hidden" name="tgmpa-page"
			value="<?php echo esc_attr( $this->menu ); ?>" /> <input
			type="hidden" name="plugin_status"
...
<?php
         ...
         * @since 2.6.0
         *       
         * @param int $install_count
         *            Number of plugins to install.
         * @param int $update_count
         *            Number of plugins to update.
         * @param int $activate_count
         *            Number of plugins to activate.
         * @param int $line_template
         *            Template for the HTML tag to output a line.
         ...
         * Does not take must-use plugins into account.
         *
         * @since 2.5.0
         *       
         * @param string $slug
        ...
        /**
         * Check if a plugin can be updated, i.e.
         * if we have information on the minimum WP version required
        ...
        /**
         * Check to see if the plugin is 'updatetable', i.e.
        ...
        /**
         * Check if a plugin can be activated, i.e.
         * is not currently active and meets the minimum
        ...
        {
            echo '<p style="float: right; padding: 0em 1.5em 0.5em 0;"><strong><small>', esc_html(sprintf(
...
/**
 * WP_List_Table isn't always available.
...
/**
 * The WP_Upgrader file isn't always available.
 * If it isn't available,
 * we load it here.
 *
        ...
        if (isset($_GET['page']) && $tgmpa_instance->menu === $_GET['page']) {
            ...
            if (! class_exists('TGMPA_Bulk_Installer')) {
                ...
                class TGMPA_Bulk_Installer extends Plugin_Upgrader
                {
                     ...
                     * @since 2.2.0
                     *       
                     * @param \Bulk_Upgrader_Skin|null $skin
                     *            Installer skin.
                     */
                     ...
                     * @see https://core.trac.wordpress.org/browser/tags/4.2.1/src/wp-admin/includes/class-wp-upgrader.php#L838 (@internal Last synced: Dec 31st 2015 against https://core.trac.wordpress.org/browser/trunk?rev=36134}}
                     *     
                     * @param array $plugins
                     *            The plugin sources needed for installation.
                     * @param array $args
            ...
            if (! class_exists('TGMPA_Bulk_Installer_Skin')) {
                ...
                class TGMPA_Bulk_Installer_Skin extends Bulk_Upgrader_Skin
                {
                    ...
                    /**
                     * Constructor.
                     * Parses default args with new ones and extracts them for use.
                     *
                     * @since 2.2.0
                     *       
                     * @param array $args
                    ...
                    public function bulk_footer()
                    {
                         ...
                         *            Array of information for the last-handled plugin.
                         */
...
if (! class_exists('TGMPA_Utils')) {
    ...
    class TGMPA_Utils
    {
        ...
        /**
         * Wrap an arbitrary string in <em> tags.
         * Meant to be used in combination with array_map().
         *
         * @since 2.5.0
         *       
         * @static
        ...
        /**
         * Wrap an arbitrary string in <strong> tags.
         * Meant to be used in combination with array_map().
         *
         * @since 2.5.0
         *       
